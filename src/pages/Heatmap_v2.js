...
function Onemap() {
  ...
  const handleTripChange = (selectedId) =>  {
    

    //Clear previous vessels name
    setvesselNames1([])
    console.log("SEelected ID ", selectedId)
    ...
    console.log("from ",selectedTrip.fromTime)
    if (selectedTrip) {

      setFromTime(selectedTrip.fromTime);
      setToTime(selectedTrip.toTime);

      console.log("set from time ", setFromTime)
      ...
      <Container >
        <Row>
          <Col md={4} style={{ width: '30%' }}>
            <Col   >
              <Form.Group className="mb-3" style={{ zIndex: '999' }}>
                <Form.Label style={{ fontWeight: 'bold' }}>Ships Data:</Form.Label>
                <Select
                  value={selectedTripId ? { value: selectedTripId, label: trips.find(trip => trip.id === selectedTripId).name } : null}
                  onChange={(selectedOption) => handleTripChange(selectedOption.value)}
              ...
              <div className="slider-container" >
                <InputGroup className="mb-3">
                  ...
                  <Button style={{ zIndex: '0' }} className="btn-custom" onClick={() => setIsPlaying(!isPlaying)}>
            ...
            {showTimeInterval && (
              <Col >
                <Form.Group>
                  <Form.Label style={{ fontWeight: 'bold' }}>HeatMap Data:</Form.Label>
                  <InputGroup className="mb-3">
                    <Form.Control
                      type="datetime-local"
            ...
            <Col style={{ zIndex: '3' }} >
              <Form.Group className="mb-3"   >
                <Form.Label style={{ fontWeight: 'bold' }}>Ship Type:</Form.Label>
                <Select
              ...
              <Button className='btn-custom' onClick={handleGenerateHeatMap}>Heat Map</Button>
            </Col>
          </Col>
          <Col md={8} style={{ width: '70%' }}>
            <Row >
              <Col>
